<template>
  ...
  >
    ...
    >
      <template slot="prepend" v-if="prependShow">
        <span style="color: #f12727"
          ><wg-icon name="icon-tishi"></wg-icon>已越级!</span
        >
      </template>
...
import { generateId } from "@/element/utils/util";
import Focus from "@/element/mixins/focus";
