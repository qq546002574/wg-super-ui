  ...
  >
    ...
    <div class="el-form-item__content" :style="contentStyle">
      ...
      <transition name="el-zoom-in-top">
        ...
        <div v-else-if="level" :class="['el-form-item__error', { 'warning-length': level === 'warning' }]">
          超过文本最大长度{{ maxlength }}
        </div>
      </transition>
    </div>
...
import objectAssign from '@/element/utils/merge';
import { noop, getPropByPath } from '@/element/utils/util';
...
export default {
  ...
  methods: {
    ...
    addValidateEvents() {
      ...
      // 监听长度变换事件
      this.$on('el.form.levelChange', ({ level, maxlength }) => {
        this.level = level;
