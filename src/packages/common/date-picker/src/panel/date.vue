<template>
  ...
  >
    <div
      v-show="visible"
      class="wg-picker-panel el-picker-panel el-date-picker el-popper"
      :class="[
        {
    ...
    >
      <div class="el-picker-panel__body-wrapper">
        ...
        <div class="el-picker-panel__body">
          <div class="el-date-picker__time-header" style="display: none">
...
export default {
  ...
  methods: {
    ...
    handleDatePick(value, callbackClickType) {
      if (this.selectionMode === "day") {
        ...
        if (callbackClickType === "date-dblclick") {
          this.emit(this.date);
        } else {
        ...
        if (this.showTime) {
          this.$nextTick(() => {
            if (!finallyVal) {
              ...
              this.$refs.dataUnion.getTime(this.value || this.defaultValue);
            }
          });
        }
        return finallyVal;
