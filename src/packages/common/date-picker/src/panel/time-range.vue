<template>
  <transition name="el-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
      v-show="visible"
      class="wg-time-range-picker el-time-range-picker el-picker-panel el-popper"
      :class="popperClass"
    >
      ...
      <div class="el-time-panel__footer">
        <wg-button @click="handleCancel()">
          {{ t("el.datepicker.cancel") }}
        </wg-button>
        <wg-button primary @click="handleConfirm()" :disabled="btnDisabled">
